	...
	<%
		...
		if(id.equals("admin") && pw.equals("1234")){
			...
			if(chkAutoLogin != null){
				...
				// id를 쿠키(cookie)에 저장시켜 놓는다.
				// session의 id를(사용자의 id가 아님) 원래 자동로그인은 DB(서버측)와 cookie(사용자측)에 저장한다. 
				Cookie cookie1 = new Cookie("session_id", session.getId());
				cookie1.setMaxAge(60 * 60 * 24 * 30);
				cookie1.setPath(request.getContextPath());	// ContextPath(02 프로젝트)에 쿠키값을 저장한다.
