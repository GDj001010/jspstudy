<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%-- prefix = 앞 고정, 직접 명시 (외우기) = 태그 이름이 c로 시작한다
	 suffix = 뒤 고정 --%>
...
<body>
	...
	<%--
		...
		2. 속성을 만드는 binding 영역 (pageContext, request, session, application)을 지정할 수 있다.
		3. 형식
	...
	<c:set var="height" value="1.76" scope="page" />
	<c:set var="weight" value="69" scope="page" />
