...
<body>
	...
	<%-- 파라미터 x,y의 크기 비교 (파라미터는 String이기 때문에 사전 편찬 순으로 크기를 비교한다.
		 값이 다르게 나타남
		 이유 : String으로 온 뒤 비교를 하기 때문에 사전에 순서대로 크기를 확인한다.
		 		우리가 아는 숫자 크기 비교가 아니다. --%>
	<ul>
